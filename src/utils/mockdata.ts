...
import { InvoiceStatus, PaymentMethod, ProductCategory, MovieStatus } from './enum';
...
export const mockMovies: MovieDTO[] = [
  {
    ...
    rating: "PG-13",
    poster_url: "https://via.placeholder.com/300x450?text=Avengers+Endgame",
  ...
  },
  {
    ...
    rating: "PG-13",
    poster_url: "https://via.placeholder.com/300x450?text=The+Batman",
  ...
  },
  {
    ...
    rating: "PG-13",
    poster_url: "https://via.placeholder.com/300x450?text=Spider-Man",
    director: "Jon Watts",
